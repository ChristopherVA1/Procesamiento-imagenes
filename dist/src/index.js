...
function opchangeFalsoColor(evt) {
    var argss = prompt('Ingresa un valor de color');
...
function rotarImg(evt) {
    var canvas = lienzo1;
    var grados = prompt('Ingresa los grados de inclinacion');
    var inclinacion = parseFloat(grados);
    pantalla2.save();
    pantalla2.translate((DefaultSettings.SIZE_WIDTH * 0.5), (DefaultSettings.SIZE_HEIGHT * 0.5));
    pantalla2.rotate((Math.PI / 180) * inclinacion);
    pantalla2.drawImage(canvas, (-DefaultSettings.SIZE_WIDTH * 0.5), (-DefaultSettings.SIZE_HEIGHT * 0.5));
    pantalla2.restore();
}
...
document.getElementById("op-RotarImagen").addEventListener('click', rotarImg, false);
//op matematicas
